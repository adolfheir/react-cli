...
module.exports = function (gMapsApi) {
  ...
  function MarkerLabel_(marker, crossURL, handCursorURL) {
    ...
    this.eventDiv_.addEventListener('selectstart', () => { return false; });
    this.eventDiv_.addEventListener('dragstart', () => { return false; });
  ...
  MarkerLabel_.prototype.onAdd = function () {
    ...
    this.listeners_ = [
      ...
      gMapsApi.event.addDomListener(document, 'mouseup', (mEvent) => {
        let position;
        if (cMouseIsDown) {
          cMouseIsDown = false;
      ...
      gMapsApi.event.addListener(me.marker_.getMap(), 'mousemove', (mEvent) => {
        let position;
        if (cMouseIsDown) {
          if (cDraggingLabel) {
      ...
      gMapsApi.event.addDomListener(document, 'keydown', (e) => {
        if (cDraggingLabel) {
      ...
      gMapsApi.event.addDomListener(this.eventDiv_, 'click', (e) => {
        if (me.marker_.getDraggable() || me.marker_.getClickable()) {
      ...
      gMapsApi.event.addDomListener(this.eventDiv_, 'dblclick', (e) => {
        if (me.marker_.getDraggable() || me.marker_.getClickable()) {
      ...
      gMapsApi.event.addListener(this.marker_, 'dragend', (mEvent) => {
        if (!cDraggingLabel) {
          if (cRaiseEnabled) {
      ...
      gMapsApi.event.addListener(this.marker_, 'position_changed', () => {
        me.setPosition();
      }),
      gMapsApi.event.addListener(this.marker_, 'zindex_changed', () => {
        me.setZIndex();
      }),
      gMapsApi.event.addListener(this.marker_, 'visible_changed', () => {
        me.setVisible();
      }),
      gMapsApi.event.addListener(this.marker_, 'labelvisible_changed', () => {
        me.setVisible();
      }),
      gMapsApi.event.addListener(this.marker_, 'title_changed', () => {
        me.setTitle();
      }),
      gMapsApi.event.addListener(this.marker_, 'labelcontent_changed', () => {
        me.setContent();
      }),
      gMapsApi.event.addListener(this.marker_, 'labelanchor_changed', () => {
        me.setAnchor();
      }),
      gMapsApi.event.addListener(this.marker_, 'labelclass_changed', () => {
        me.setStyles();
      }),
      gMapsApi.event.addListener(this.marker_, 'labelstyle_changed', () => {
        me.setStyles();
      }),
    ];
  };
  ...
  MarkerLabel_.prototype.setPosition = function (yOffset) {
    const position = this.getProjection().fromLatLngToDivPixel(this.marker_.getPosition());
